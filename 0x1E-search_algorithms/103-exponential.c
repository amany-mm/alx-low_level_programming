...
int exponential_search(int *array, size_t size, int value)
{
	...
	/* Start with assumption that value is present at beginning of array */
	mid = 1;

	/* Use exponential search to narrow down search space */
	...
	/* Perform binarySearch within identified range to find exact value position*/
